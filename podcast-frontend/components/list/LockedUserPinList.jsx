...
const LockedUserPinList = () => {
  ...
  async function getAllUsers() {
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/admin/users/locked`,
        requestOptions
      );
  ...
  async function getAllUsersByQuery() {
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/admin/users/locked/query/${searchQuery}`,
        requestOptions
      );
  ...
  async function getAllUsersByCategory() {
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/admin/users/locked/category/${category}`,
        requestOptions
      );
...
export default LockedUserPinList;
